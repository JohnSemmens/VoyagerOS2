...
char Version[] = "vOS2.2.35";
char VersionDate[] = "30/4/2022";
...
//Time GPSUTCTime;				// Current Time from GPS. We'll call it UTC, even though that's not strictly the same.
//Time GPSLocalTime;				// Time from GPS converted to local time by applying timezone offset.
time_t GPSTime;

//Time CurrentLocalTime;				// Current Local Time converted - system time from timelib.h
