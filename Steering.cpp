...
void SteeringFastUpdate(void)
{
	...
	// debug code
	//Serial.print("Steering:Hdg:");
	//Serial.print(NavData.HDG);
	//Serial.print(",Target:");
	//Serial.print(NavData.TargetHDG);
	//Serial.print(",pidError:");
	//Serial.print(pidActualHdgError);
	//Serial.print(",pidOut:");
	//Serial.print(pidServoOutput);
	//Serial.print(",ServoOut:");
	//Serial.print(SteeringServoOutput);
	//Serial.println();
	...
	if (Configuration.DualRudder)
	{
		...
		{ // operate the Starboard Rudder
			Servo_Out(Configuration.Servo_Channel_Steering_Stbd, SteeringServoOutput_LPF);
			StarboardRudderUsage.TrackServoUsage(SteeringServoOutput_LPF);
		}
		else
		{ // operate the  Port Rudder
			Servo_Out(Configuration.Servo_Channel_Steering, SteeringServoOutput_LPF);
