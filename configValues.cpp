...
// V1.10 4/2/2022 added support for differnt default config settings based on HardWare Config setting.
...
void Load_Config_default_values(void)
{
	...
	case 0:
		...
		Configuration.CompassError270 = +1;
	...
	case 1:
		...
		Configuration.CompassOffsetAngle = 90; // degrees
				...
				// Compass USFS Max
		// Cardinal corrections
		Configuration.CompassError000 = 0;
		Configuration.CompassError090 = 0;
		Configuration.CompassError180 = 0;
