...
void CLI_Processor(int CommandPort)
{
	...
	// Split into command and parameters separated by commas. 
	strncpy(Fullcmd, strtok(CLI_Msg, ","),sizeof(Fullcmd)-1);
	...
	// add check that full command is present before assigning values, and hence clearing them
	NextAddr = Fullcmd[0];
	FinalAddr = Fullcmd[1];
	PrevAddr = Fullcmd[2];
	SourceAddr = Fullcmd[3];
	cmd[0] = Fullcmd[4];
	cmd[1] = Fullcmd[5];
	cmd[2] = Fullcmd[6];
	cmd[3] = '\0';
	...
	// ===============================================
	if (!strncmp(cmd, "ech",3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	if (!strncmp(cmd, "mcs",3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	if (!strncmp(cmd, "scs",3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	if (!strncmp(cmd, "scg", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{		
	...
	// Parameter 1: Mission Sequence Number  
	if (!strncmp(cmd, "mis",3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// No parameters
	if (!strncmp(cmd, "mig",3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// No parameters
	if (!strncmp(cmd, "mcl",3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// return the whole Mission Command list; no parameters needed.
	// No parameters
	if (!strncmp(cmd, "mcp", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// No parameters
	if (!strncmp(cmd, "mcc",3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	if (!strncmp(cmd, "lcs", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// 
	if (!strncmp(cmd, "hls", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// ===============================================
	// No parameters
	if (!strncmp(cmd, "hlg", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
		QueueMessage(TelMessageType::HLG);
	}
	...
	// ===============================================
	// No parameters
	if (!strncmp(cmd, "hlc", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
		// Clear the flag
	...
	// ===============================================
	// No parameters
	if (!strncmp(cmd, "ver", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// ===============================================
	// No parameters
	if (!strncmp(cmd, "tmg", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// 
	if (!strncmp(cmd, "lcd", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// No Parameter
	// 
	if (!strncmp(cmd, "rst", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	if (!strncmp(cmd, "eqg", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	//  No parameters
	// 
	if (!strncmp(cmd, "ccs", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
...
//		IMU_Save_Cal();
	...
	//  No parameters
	// 
	if (!strncmp(cmd, "ccg", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	//  No parameters
	// 
	if (!strncmp(cmd, "wc1", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	//  No parameters
	// 
	if (!strncmp(cmd, "wc0", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	//  two parameters
	// 
	if (!strncmp(cmd, "wsc", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// 
	if (!strncmp(cmd, "sav", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// 
	if (!strncmp(cmd, "dsp", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	if (!strncmp(cmd, "prl", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// 
	if (!strncmp(cmd, "prg", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// 
	if (!strncmp(cmd, "prs", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	//	char MsgString[16];
	...
	if (!strncmp(cmd, "lna", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// ===============================================
	// No Parameters
	if (!strncmp(cmd, "lat", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// ===============================================
	// No Parameters
	if (!strncmp(cmd, "lpo", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// ===============================================
	// No Parameters
	if (!strncmp(cmd, "lwp", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// ===============================================
	// No Parameters
	if (!strncmp(cmd, "lmi", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// ===============================================
	// No Parameters
	if (!strncmp(cmd, "lwi", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// ===============================================
	// No Parameters
	if (!strncmp(cmd, "lvs", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// ===============================================
	// No Parameters
	if (!strncmp(cmd, "lpf", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// ===============================================
	// No Parameters
	if (!strncmp(cmd, "lsv", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	if (!strncmp(cmd, "gsv", 3) && (NextAddr == 'v') && (FinalAddr == 'v') )
	{
	...
	//pow - Get Wingsail Power response
	if (!strncmp(cmd, "pow", 3) && (NextAddr == 'v') && (FinalAddr == 'v'))
	{
	...
	// ===============================================
	// Relay Message
	// Next Address is Vessel, but final Address is not Vessel
	// Could be from wing to Base Station, or vice versa
	// ===============================================
	if ((NextAddr == 'v') && (FinalAddr != 'v'))
	{
		Serial.print("Relay");
		Serial.print(",");
		Serial.println(PrevAddr);

		Set_LoRa_Mode(LoRa_Mode_Type::TxShortRange);

		WakeupPrefix(CommandPort, FinalAddr); 
		(*Serials[CommandPort]).print(FinalAddr);  // Next Address, Final Address
		(*Serials[CommandPort]).print(FinalAddr);  // Final Address, No change
		(*Serials[CommandPort]).print("v");		  // Previous Address, 'W'
		(*Serials[CommandPort]).print(SourceAddr); // Source Address, No change
		(*Serials[CommandPort]).print(cmd);	// Command

		// check the length of each parameter, up to 7,  and relay it on, if present.
		if (strlen(param1) > 0) {
			(*Serials[CommandPort]).print(",");
			(*Serials[CommandPort]).print(param1);
		}
